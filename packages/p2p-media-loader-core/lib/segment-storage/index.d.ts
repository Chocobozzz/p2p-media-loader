...
export interface SegmentStorage {
     ...
     * @param isLiveStream Indicates whether the stream is live.
     */
    storeSegment(swarmId: string, streamSwarmId: string, segmentId: number, data: ArrayBuffer, startTime: number, endTime: number, streamType: StreamType, isLiveStream: boolean): Promise<void>;
    /**
     ...
     * @param segmentId The segment identifier.
     */
    getSegmentData(swarmId: string, streamSwarmId: string, segmentId: number): Promise<ArrayBuffer | undefined>;
    /**
     ...
     */
    hasSegment(swarmId: string, streamSwarmId: string, segmentId: number): boolean;
    /**
