 ...
 */
export type StreamRegistration<TStream extends Stream = Stream> = Omit<TStream, "swarmId" | "identityHash" | "streamSwarmId" | "infoHash">;
...
export type DynamicStreamProperties = "highDemandTimeWindow" | "httpDownloadInitialTimeoutMs" | "httpDownloadTimeWindow" | "p2pDownloadTimeWindow" | "simultaneousHttpDownloads" | "simultaneousP2PDownloads" | "webRtcMaxMessageSize" | "p2pNotReceivingBytesTimeoutMs" | "p2pInactiveLoaderDestroyTimeoutMs" | "httpNotReceivingBytesTimeoutMs" | "httpErrorRetries" | "p2pErrorRetries" | "validateP2PSegment" | "validateHTTPSegment" | "httpRequestSetup" | "isP2PDisabled" | "isP2PUploadDisabled" | "p2pMaxPeers" | "p2pChurnMaxPeersMultiplier" | "p2pChurnCleanupIntervalMs" | "p2pChurnGracePeriodMs" | "webRtcOffersCount" | "webRtcOfferTimeoutMs" | "webRtcIceGatheringTimeoutMs" | "webRtcConnectionTimeoutMs" | "rtcConfig";
/**
 ...
 * ```
 */
export type DynamicCoreConfig = Partial<Pick<CoreConfig, DynamicStreamProperties>> & Partial<CommonCoreConfig> & {
...
export type DynamicStreamConfig = Partial<Pick<StreamConfig, DynamicStreamProperties>>;
 ...
 * ```
 */
export type CoreConfig = Partial<StreamConfig> & Partial<CommonCoreConfig> & {
    /** Optional configuration for the main stream. */
...
export type StreamConfig = {
     ...
     * ```
     */
    streamSwarmIdBuilder?: (context: StreamSwarmIdBuilderContext) => string | undefined;
    /**
     ...
     * ```
     */
    validateHTTPSegment?: (url: string, byteRange: ByteRange | undefined, data: ArrayBuffer) => Promise<boolean>;
    /**
     ...
     * ```
     */
    httpRequestSetup?: (segmentUrl: string, segmentByteRange: ByteRange | undefined, requestAbortSignal: AbortSignal | undefined, requestByteRange: {
        start: number;
        end?: number;
...
export type SegmentAbortDetails = Omit<SegmentEventDetails, "downloadSource"> & {
...
export type PeerErrorType = "transport-error" | "protocol-violation" | "bytes-length-mismatch" | "validation-failed" | "timeout" | "connection-lost";
/**
 ...
 */
export declare abstract class TypedError<T extends string> extends Error {
    readonly type: T;
    readonly cause?: unknown;
    constructor(type: T, message?: string, cause?: unknown);
}
/** Represents an error that occurred during a peer connection. */
export declare class PeerError extends TypedError<PeerErrorType> {
...
export declare class PeerWarning extends TypedError<PeerWarningType> {
...
export type TrackerErrorType = "announce-failed" | "parse-error" | "tracker-response" | "signaling-failed";
/** Represents an error that occurred during a tracker request. */
export declare class TrackerError extends TypedError<TrackerErrorType> {
...
export declare class TrackerWarning extends TypedError<TrackerWarningType> {
...
export declare class PeerConnectError extends TypedError<PeerConnectErrorType> {
...
export type CoreEventMap = {
     ...
     */
    onChunkDownloaded: (bytesLength: number, downloadSource: DownloadSource, peerId: string | undefined, streamType: StreamType, infoHash: string) => void;
    /**
     ...
     * @param infoHash - The info hash of the swarm that the chunk belongs to.
     */
    onChunkUploaded: (bytesLength: number, peerId: string, streamType: StreamType, infoHash: string) => void;
    /**
...
export type HttpRequestErrorType = "http-error" | "http-bytes-mismatch" | "http-unexpected-status-code" | "http-segment-validation-failed";
/** Defines the types of errors specific to peer-to-peer requests. */
export type PeerRequestErrorType = "peer-segment-absent" | "peer-closed" | "p2p-segment-validation-failed";
/** Enumerates all possible request error types, including HTTP and peer-related errors. */
export type RequestErrorType = RequestAbortErrorType | PeerRequestErrorType | HttpRequestErrorType;
/**
 ...
 */
export declare class RequestError<T extends RequestErrorType = RequestErrorType> extends TypedError<T> {
...
export declare class CoreRequestError extends TypedError<"failed" | "aborted"> {
